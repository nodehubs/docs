...
if __name__ == '__main__':  # 确保该模块被直接运行时才执行以下代码
    ...
    model = YOLO(model=r'G:\项目\基于Jetson nano的智能车\yolo\codelast\200+种YOLOv11检测分割算法改进源码配置文件大全\改进YOLOv11检测模型配置文件\yolo11-efficientViT.yaml', task='detect').load('./yolo11n.pt') # yolo11-efficientViT.yaml、yolo11-ADown.yaml、...
